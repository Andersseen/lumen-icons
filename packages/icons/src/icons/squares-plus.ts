...
@Component({
  ...
  styles: [`
    @keyframes lmn-squares-plus { 0%, 100% { scale: 1; } 50% { scale: 1.12; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-squares-plus 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnSquaresPlusIcon extends LmnIconBase {}
