...
@Component({
  ...
  styles: [`
    ...
    .lmn-animate-el { display: inline-block; }
      ...
      @keyframes lmn-badge {
        0%, 100% { scale: 1 1; scale: 1 1; opacity: 1; }
        50% { scale: 1.068 1; scale: 1 0.962; opacity: 0.937; }
      }
  `],
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()" [style.animation]="animate() ? 'lmn-badge 560ms ease both' : null" viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
