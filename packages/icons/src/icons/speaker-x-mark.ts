...
@Component({
  ...
  styles: [`
    @keyframes lmn-speaker-x-mark { 0%, 100% { scale: 1; } 50% { scale: 1.08; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-speaker-x-mark 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnSpeakerXMarkIcon extends LmnIconBase {}
