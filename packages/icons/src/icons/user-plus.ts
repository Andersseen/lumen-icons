...
@Component({
  ...
  styles: [`
    @keyframes lmn-user-plus { 0%, 100% { scale: 1; } 50% { scale: 1.12; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-user-plus 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnUserPlusIcon extends LmnIconBase {}
