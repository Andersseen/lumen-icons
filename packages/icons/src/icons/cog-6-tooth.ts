...
@Component({
  ...
  styles: [`
    @keyframes lmn-cog-6-tooth { 0% { rotate: 0deg; } 100% { rotate: 360deg; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-cog-6-tooth 1000ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnCog6ToothIcon extends LmnIconBase {}
