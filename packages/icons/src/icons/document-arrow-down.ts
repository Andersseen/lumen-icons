...
@Component({
  ...
  styles: [`
    @keyframes lmn-document-arrow-down { 0%, 100% { translate: 0 0; } 50% { translate: 0 5px; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-document-arrow-down 400ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnDocumentArrowDownIcon extends LmnIconBase {}
