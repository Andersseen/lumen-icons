...
@Component({
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-send 500ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
    ...
    >
      <path
        ...
        class="lmn-animate-el" [style.animation]="animate() ? 'lmn-send-plane 620ms cubic-bezier(0.22, 1, 0.36, 1) 0ms both' : null"/><path
        d="M22 2 11 13"
