...
@Component({
  ...
  styles: [`
    @keyframes lmn-globe-asia-australia { 0%, 100% { scale: 1; } 50% { scale: 1.08; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-globe-asia-australia 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnGlobeAsiaAustraliaIcon extends LmnIconBase {}
