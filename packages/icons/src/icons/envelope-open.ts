...
@Component({
  ...
  styles: [`
    @keyframes lmn-envelope-open { 0%, 100% { translate: 0 0; } 25% { translate: 0 -3px; } 75% { translate: 0 3px; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-envelope-open 550ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnEnvelopeOpenIcon extends LmnIconBase {}
