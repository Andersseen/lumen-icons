...
@Component({
  ...
  styles: [`
    @keyframes lmn-document-arrow-up { 0%, 100% { translate: 0 0; } 50% { translate: 0 -2px; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-document-arrow-up 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnDocumentArrowUpIcon extends LmnIconBase {}
