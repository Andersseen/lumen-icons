...
@Component({
  ...
  styles: [`
    @keyframes lmn-bookmark-slash { 0%, 100% { scale: 1; } 50% { scale: 1.08; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-bookmark-slash 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnBookmarkSlashIcon extends LmnIconBase {}
