...
@Component({
  ...
  styles: [`
    @keyframes lmn-fire { 0%, 100% { opacity: 1; scale: 1; } 50% { opacity: 0.8; scale: 0.95; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-fire 560ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnFireIcon extends LmnIconBase {}
