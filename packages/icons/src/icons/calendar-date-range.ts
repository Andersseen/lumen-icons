...
@Component({
  ...
  styles: [`
    @keyframes lmn-calendar-date-range { 0%, 100% { scale: 1; } 50% { scale: 1.1; } }
  ...
  template: `
    <svg
      ...
      [class.lmn-animate]="animate()"
      [style.animation]="animate() ? 'lmn-calendar-date-range 500ms ease both' : null"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export class LmnCalendarDateRangeIcon extends LmnIconBase {}
